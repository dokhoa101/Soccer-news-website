...
Route::get('top_news/{category_name}/{id}', [HomeController::class,'top_news']);
Route::get('top_news_specific/{category_name}/{categoryid}/{leagueid}', [HomeController::class,'top_news_specific']);
Route::get('details/{id}', [HomeController::class,'details']);
Route::get('search', [HomeController::class,'search']);

Route::post('comment/{news_id}/{user_id}', [HomeController::class,'comment'])->middleware(['auth', 'verified']);
